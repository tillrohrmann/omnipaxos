...
cargo nextest run --features "logging, toml_config" --workspace --all-targets --target-dir target/tests
cargo nextest run --features "logging, toml_config, unicache" -p omnipaxos --all-targets --target-dir target/tests
cargo fmt --all -- --check
